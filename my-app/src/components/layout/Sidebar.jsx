...
const icons = {
  ...
  students: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M2 16c0-3.314 2.462-5 5.5-5s5.5 1.686 5.5 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <circle cx="14" cy="7" r="2" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M17 16c0-2.21-1.343-3.8-3-4.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  teachers: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  groups: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M1.5 16c0-2.21 1.119-3.5 2.5-3.5.62 0 1.19.23 1.66.62" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M18.5 16c0-2.21-1.119-3.5-2.5-3.5-.62 0-1.19.23-1.66.62" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M6 16c0-2.76 1.79-4.5 4-4.5s4 1.74 4 4.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  users: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M14 8c1.657 0 3 1.343 3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M17 17c0-1.657-.895-3-2-3.8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  audit: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  examAbsences: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M6 2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Z" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M8 9l4 4m0-4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  rattrapages: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M3.5 10a6.5 6.5 0 1 1 1.9 4.6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M3.5 14.5V10H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  statistics: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M3 15l4-5 4 3 5-7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3 17h14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  notifications: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M10 2.5A5.5 5.5 0 0 0 4.5 8v3.5L3 13h14l-1.5-1.5V8A5.5 5.5 0 0 0 10 2.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
      <path d="M8 13v.5a2 2 0 0 0 4 0V13" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  ),
  settings: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <circle cx="10" cy="10" r="2.5" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M10 2.5v1.25M10 16.25v1.25M17.5 10h-1.25M3.75 10H2.5M15.3 4.7l-.884.884M5.584 14.416l-.884.884M15.3 15.3l-.884-.884M5.584 5.584l-.884-.884" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  help: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  logout: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M13 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M17 10H8m9 0-2.5-2.5M17 10l-2.5 2.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  chevron: (
