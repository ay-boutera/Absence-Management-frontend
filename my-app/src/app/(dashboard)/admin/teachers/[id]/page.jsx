...
function TeacherDonut({ data, total }) {
  const pct = 85;
  return (
...
function RoleCard({ role, onSave }) {
  ...
  return (
    <div
      ref={ref}
      className="box-border flex flex-col items-start px-4 py-[14px] gap-[6px] bg-white border border-black/10 rounded-[10px] relative"
    >
      <div className="flex items-center gap-2">
        ...
        >
          <path
            d="M7.09349 6.34079C7.03516 6.33496 6.96516 6.33496 6.90099 6.34079C5.51266 6.29413 4.41016 5.15663 4.41016 3.75663C4.41016 2.32746 5.56516 1.16663 7.00016 1.16663C8.42932 1.16663 9.59016 2.32746 9.59016 3.75663C9.58432 5.15663 8.48182 6.29413 7.09349 6.34079Z"
            stroke="#999999"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M4.17691 8.49337C2.76525 9.43837 2.76525 10.9784 4.17691 11.9175C5.78108 12.9909 8.41191 12.9909 10.0161 11.9175C11.4277 10.9725 11.4277 9.43254 10.0161 8.49337C8.41775 7.42587 5.78691 7.42587 4.17691 8.49337Z"
            stroke="#999999"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
        ...
        <span className="text-3.5 text-[#999999]">Role</span>
      </div>
      <div className="flex items-center gap-2">
      ...
      {open && (
        <div className="absolute top-full left-0 z-50 bg-white border border-black/10 rounded-[8px] shadow-[0_4px_12px_rgba(0,0,0,0.1)] min-w-[160px] mt-1 overflow-hidden">
...
function ClassCard({ subject, year, groups = [] }) {
    ...
    <div className="box-border flex flex-col bg-white border border-black/10 rounded-[8px] flex-1 min-w-0">
      ...
      <div className="flex flex-row flex-wrap px-4 py-[10px] gap-[6px] border-t border-b border-black/10 ">
        {groups.map((g) => (
          <span
            key={g}
            className="px-2.75 py-0.75 border border-black/10 rounded-[60px] text-[12px] font-[Inter,sans-serif]"
          >
            {g}
          </span>
        ))}
...
export default function TeacherProfilePage() {
  ...
  return (
    <div className="main-page">
      ...
      >
        <div className="main-header-text">
          ...
          >
            ...
            >
              {fromAdmins ? "Administrators" : "Teachers"}
            </Link>
            {" > "}
            <span className="main-title">{fromAdmins ? "Administrator Profile" : "Teacher Profile"}</span>
          </h2>
          <p className="main-subtitle">{fromAdmins ? "View and manage Administrators" : "View and manage Teachers"}</p>
        </div>
        <button className="flex items-center gap-[6px] px-[14px] py-[6px] bg-[#F8FAFF] border border-black/10 rounded-[8px] text-[14px] text-[#143888] cursor-pointer">
          Edit
          <svg
            width="14"
            height="14"
      ...
      {/* li lfoug charts and cards and photo */}
      <div className="flex flex-row gap-[25px] items-stretch">
        <div className="box-border flex flex-col items-center p-5 gap-5 w-[210px] shrink-0 bg-white border border-black/10 rounded-[8px]">
          ...
          <div style={{ position: "relative", width: 106, height: 106 }}>
            <div className="w-[106px] h-[106px] rounded-full bg-[linear-gradient(135deg,#c3d4f5_0%,#94b4ee_100%)] flex items-center justify-center">
              {teacher.avatar_url ? (
                <img
                ...
                <span
                  style={{ fontSize: 36, fontWeight: 700, color: "#143888" }}
                >
                  {initials}
                </span>
              )}
            ...
            <div className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-[linear-gradient(180deg,#3264D2_0%,#143888_100%)] flex items-center justify-center cursor-pointer">
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
          ...
          {/* Info */}
          <div className="flex flex-col gap-5.25 w-full items-start">
            <div className="flex flex-col gap-2 w-full text-center">
              <span className="text-[18px] font-bold text-black">
                {fullName}
              </span>

              <span className="text-[12px] text-black/40">{role}</span>

              <span className="text-[12px] text-black/40">{teacher.email}</span>
            </div>
        ...
        <div className="flex flex-col justify-between gap-[25px] w-[207px] shrink-0">
          <div className="box-border flex flex-col gap-[6px] px-4 py-[14px] bg-white border border-black/10 rounded-[10px]">
          ...
          <div className="box-border flex flex-col gap-[6px] px-4 py-[14px] bg-white border border-black/10 rounded-[10px]">
            ...
            <span style={{ fontSize: 14, fontWeight: 500, color: "#000" }}>
              {classes.reduce((sum, c) => sum + (c.groups?.length || 0), 0)}
            </span>
          </div>

          <RoleCard role={role} onSave={handleRoleSave} />
        </div>
      </div>

      {/* ── Classes & groups ── */}
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <h3 style={{ fontSize: 14, fontWeight: 600, color: "#000", margin: 0 }}>
          Classes &amp; groups
        </h3>
